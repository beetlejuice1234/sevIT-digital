...
import { ArrowLeft, ArrowRight, Box, Layers, Sparkles, Camera, Cpu, Globe, Play, Zap } from 'lucide-react';
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20 z-10">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/10 border border-red-500/30 rounded-full mb-10">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-red-400">3D Render Studio</span>
          </div>
          ...
          <h1 className="text-6xl sm:text-7xl lg:text-9xl font-black leading-[0.85] tracking-tighter mb-10">
            ...
            <span className="hero-line block text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-red-500 to-orange-500 opacity-0">
              ATTENTION.
            </span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            ...
            <div className="bento-block lg:col-span-2 lg:row-span-2 opacity-0">
              <div className="group relative h-full min-h-[500px] lg:min-h-[700px] rounded-3xl overflow-hidden bg-white/[0.02] border border-white/10 hover:border-red-500/50 transition-all duration-700">
                <img 
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <span className="text-xs uppercase tracking-[0.2em] text-red-400 mb-3 block">Material Simulation</span>
            ...
            <div className="bento-block lg:col-span-1 lg:row-span-1 opacity-0">
              <div className="group relative h-full min-h-[340px] rounded-3xl overflow-hidden bg-white/[0.02] border border-white/10 hover:border-red-500/50 transition-all duration-700">
                <img 
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <span className="text-xs uppercase tracking-[0.2em] text-red-400 mb-2 block">Lighting</span>
            ...
            <div className="bento-block lg:col-span-1 lg:row-span-1 opacity-0">
              <div className="group relative h-full min-h-[340px] rounded-3xl overflow-hidden bg-white/[0.02] border border-white/10 hover:border-red-500/50 transition-all duration-700">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <span className="text-xs uppercase tracking-[0.2em] text-red-400 mb-2 block">Topology</span>
            ...
            <div className="bento-block lg:col-span-1 lg:row-span-1 opacity-0">
              <div className="group relative h-full min-h-[340px] rounded-3xl overflow-hidden bg-white/[0.02] border border-white/10 hover:border-red-500/50 transition-all duration-700">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <span className="text-xs uppercase tracking-[0.2em] text-red-400 mb-2 block">Environment</span>
            ...
            <div className="bento-block lg:col-span-1 lg:row-span-1 opacity-0">
              <div className="group relative h-full min-h-[340px] rounded-3xl overflow-hidden bg-white/[0.02] border border-white/10 hover:border-red-500/50 transition-all duration-700">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <span className="text-xs uppercase tracking-[0.2em] text-red-400 mb-2 block">Composition</span>
            ...
            <div className="bento-block lg:col-span-2 lg:row-span-1 opacity-0">
              <div className="group relative h-full min-h-[340px] rounded-3xl overflow-hidden bg-white/[0.02] border border-white/10 hover:border-red-500/50 transition-all duration-700">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <span className="text-xs uppercase tracking-[0.2em] text-red-400 mb-3 block">Animation</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  <div className="relative h-full p-8 lg:p-10 rounded-3xl bg-white/[0.02] border border-white/10 hover:border-red-500/50 transition-all duration-500 overflow-hidden">
                    {/* Glow effect */}
                    <div className="absolute -top-20 -right-20 w-40 h-40 rounded-full bg-red-500/20 blur-3xl opacity-20 group-hover:opacity-40 transition-opacity" />

                    {/* Icon */}
                    <div className="relative w-16 h-16 rounded-2xl bg-red-500/20 flex items-center justify-center mb-8">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-20">
            <p className="text-xl sm:text-2xl text-white/70 leading-relaxed max-w-4xl mx-auto">
              Because they are <span className="text-red-500 font-bold">engineered</span> that way.
            </p>
      ...
      <section className="relative py-32 px-6 lg:px-12 z-10 border-t border-white/10 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl text-white font-bold mb-12">
            It's time to <span className="text-red-500">dominate</span>.
          </p>
