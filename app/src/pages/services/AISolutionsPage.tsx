...
import { ArrowLeft, Mic, Send, Bot, Sparkles, Cpu, MessageSquare, Zap, Volume2, VolumeX, Loader2 } from 'lucide-react';
...
function JarvisAI() {
  ...
  // Canvas animation for the AI orb
  useEffect(() => {
    ...
    const draw = () => {
      ...
      gradient.addColorStop(0, `rgba(239, 68, 68, ${glowIntensity * 0.5})`);
      gradient.addColorStop(0.5, `rgba(249, 115, 22, ${glowIntensity * 0.3})`);
      ...
      coreGradient.addColorStop(0, isListening ? '#EF4444' : isThinking ? '#F97316' : 'rgba(239, 68, 68, 0.8)');
      coreGradient.addColorStop(0.5, isListening ? 'rgba(239, 68, 68, 0.5)' : 'rgba(239, 68, 68, 0.3)');
        ...
        <div className="flex-1 w-full max-w-lg">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="flex-1 bg-white/5 border border-white/10 rounded-full px-5 py-3 text-white placeholder-white/30 focus:outline-none focus:border-red-500/50"
            />
            <button
              onClick={handleSend}
              disabled={!inputText.trim() || isThinking}
              className="w-12 h-12 rounded-full bg-red-500 flex items-center justify-center disabled:opacity-50 hover:bg-red-600 transition-colors"
            >
...
function ServiceCard({ icon: Icon, title, description, tags }: { 
  ...
  return (
    <div className="group relative bg-white/[0.02] border border-white/10 rounded-2xl p-6 hover:border-red-500/50 transition-all duration-500 hover:bg-white/[0.04]">
    ...
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 lg:px-12 pt-24 pb-12 z-10">
        <div className="absolute inset-0 pointer-events-none" 
          style={{ background: 'radial-gradient(ellipse at 50% 50%, rgba(239, 68, 68, 0.12) 0%, transparent 60%)' }} 
        />
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/10 border border-red-500/30 rounded-full mb-6">
              ...
              <span className="text-xs uppercase tracking-[0.3em] text-red-400">AI Solutions</span>
            </div>
      ...
      <section className="services-section relative py-24 px-6 lg:px-12 z-10 border-t border-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-sm text-red-400 uppercase tracking-wider">Capabilities</span>
