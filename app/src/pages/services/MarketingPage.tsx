...
import { ArrowLeft, ArrowRight, Search, Mail, BarChart3, Rocket, GripHorizontal, Target } from 'lucide-react';
        ...
        <div className="space-y-8">
          ...
          <div className="relative">
            ...
            <div className="relative h-14 bg-white/5 rounded-2xl border border-white/10 flex items-center px-4">
              <div className="absolute left-4 right-4 top-1/2 -translate-y-1/2 h-2 bg-white/10 rounded-full">
                <div className="h-full bg-gradient-to-r from-red-500 to-orange-500 rounded-full transition-all" style={{ width: `${(monthlyTraffic / 50000) * 100}%` }} />
              </div>
          ...
          <div className="relative">
            ...
            <div className="relative h-14 bg-white/5 rounded-2xl border border-white/10 flex items-center px-4">
              ...
              <div className="absolute top-1/2 -translate-y-1/2 w-10 h-10 bg-red-500 rounded-xl flex items-center justify-center shadow-lg shadow-red-500/30 pointer-events-none transition-all" style={{ left: `calc(${((avgOrderValue - 50) / 450) * 100}% - 20px + 16px)` }}>
                <GripHorizontal className="w-5 h-5 text-white" />
              </div>
            </div>
            <div className="flex justify-between mt-2 px-4">
...
function ServiceCard({ icon: Icon, title, description, features }: { 
  ...
  return (
    <div className="group relative bg-white/[0.02] border border-white/10 rounded-3xl p-8 hover:border-red-500/50 transition-all duration-500">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center px-6 lg:px-12 pt-32 z-10">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/10 border border-red-500/30 rounded-full mb-8">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-red-400">Growth Marketing</span>
          </div>
      ...
      <section className="calculator-section relative py-24 px-6 lg:px-12 z-10 border-t border-white/10">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <span className="text-sm text-red-400 uppercase tracking-wider">Growth Calculator</span>
