        ...
        <div className="space-y-10">
          ...
          <div className="flex items-center gap-4 p-4 bg-amber-500/10 rounded-2xl border border-amber-500/20">
            ...
            <div>
              ...
              <span className="text-2xl font-black text-amber-500">{targetROAS}x</span>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center px-6 lg:px-12 pt-32 z-10">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <div className="hero-line opacity-0">
            <Link 
              to="/#chat" 
              className="inline-flex items-center gap-3 px-8 py-4 bg-amber-500 text-white rounded-full font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-all group"
            >
      ...
      <section className="relative py-16 px-6 lg:px-12 z-10 border-t border-white/10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <span className="text-sm text-amber-400 uppercase tracking-wider">Our Process</span>
      ...
      <section className="relative py-32 px-6 lg:px-12 z-10 border-t border-white/10 overflow-hidden">
        <div 
          ...
          style={{ background: 'radial-gradient(ellipse at center, rgba(245, 158, 11, 0.2) 0%, transparent 60%)' }} 
        />
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <Link 
            to="/#chat" 
            className="inline-flex items-center gap-3 px-10 py-5 bg-amber-500 text-white rounded-full font-bold text-lg uppercase tracking-wider hover:bg-white hover:text-black transition-all group"
          >
