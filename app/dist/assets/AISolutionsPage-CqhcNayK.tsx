...
function MobileSwipeCarousel({ children, activeColor = 'bg-cyan-500' }: { children: React.ReactNode[], activeColor?: string }) {
      ...
      <section className="services-section relative py-24 px-6 lg:px-12 z-10 border-t border-white/10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="hidden md:grid grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="service-card opacity-0 h-full">
              <ServiceCard
                icon={MessageSquare}
                title="AI Chatbots"
          ...
          {/* Mobile Carousel */}
          <MobileSwipeCarousel activeColor="bg-cyan-500">
            <ServiceCard
              icon={MessageSquare}
              title="AI Chatbots"
              description="24/7 intelligent customer support that understands context and escalates seamlessly."
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <MobileSwipeCarousel activeColor="bg-red-500">
            {[
              ...
              <div key={i} className="bg-white/[0.02] border border-white/10 rounded-2xl p-8 text-center h-full flex flex-col justify-center">
                <span className="text-5xl font-black text-red-500/50 mb-3 block">{item.num}</span>
